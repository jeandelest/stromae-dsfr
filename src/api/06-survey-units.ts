...
import type {
  ...
  StateDataDto,
  StateDataInput,
  SurveyUnitByCampaignDto,
  SurveyUnitCreationInput,
  SurveyUnitDataStateDataUpdateInput,
  SurveyUnitDto,
  SurveyUnitOkNokDto,
  SurveyUnitUpdateInput,
  UpdateCollectedDataBody,
  UpdateDataBody,
} from '../model/api'
...
export const getSurveyUnitById = (
  ...
  return stromaeInstance<SurveyUnitDto>(
...
export const updateSurveyUnitById = (
  id: string,
  surveyUnitUpdateInput: SurveyUnitUpdateInput,
  options?: SecondParameter<typeof stromaeInstance>
) => {
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: SurveyUnitUpdateInput },
    TContext
  >
  request?: SecondParameter<typeof stromaeInstance>
}): UseMutationOptions<
...
export type UpdateSurveyUnitByIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateSurveyUnitById>>
>
export type UpdateSurveyUnitByIdMutationBody = SurveyUnitUpdateInput
...
/**
 * Authorized roles: ADMIN / WEBCLIENT / REVIEWER / REVIEWER_ALTERNATIVE / INTERVIEWER / SURVEY_UNIT /
 * @summary Update survey-unit data/state-data
 */
export const updateSurveyUnitDataStateDataById = (
  id: string,
  surveyUnitDataStateDataUpdateInput: SurveyUnitDataStateDataUpdateInput,
  options?: SecondParameter<typeof stromaeInstance>
) => {
  return stromaeInstance<void>(
    {
      ...
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      data: surveyUnitDataStateDataUpdateInput,
    },
    options
  )
}
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: SurveyUnitDataStateDataUpdateInput },
    TContext
  >
  request?: SecondParameter<typeof stromaeInstance>
}): UseMutationOptions<
...
export const getStateDataBySurveyUnit = (
  ...
  return stromaeInstance<StateDataDto>(
...
export type SetStateDataMutationResult = NonNullable<
  Awaited<ReturnType<typeof setStateData>>
>
export type SetStateDataMutationBody = StateDataInput
...
export type SetPersonalizationMutationResult = NonNullable<
  Awaited<ReturnType<typeof setPersonalization>>
>
export type SetPersonalizationMutationBody = ArrayNode
...
/**
 * Authorized roles: ADMIN / WEBCLIENT / REVIEWER / REVIEWER_ALTERNATIVE / INTERVIEWER / SURVEY_UNIT /
 * @summary Update collected data for a survey unit
 */
export const updateCollectedData = (
  id: string,
  updateCollectedDataBody: UpdateCollectedDataBody,
  options?: SecondParameter<typeof stromaeInstance>
) => {
  return stromaeInstance<void>(
    {
      ...
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      data: updateCollectedDataBody,
    },
    options
  )
}

export const getUpdateCollectedDataMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateCollectedData>>,
    TError,
    { id: string; data: UpdateCollectedDataBody },
    TContext
  >
  request?: SecondParameter<typeof stromaeInstance>
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return updateCollectedData(id, data, requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type UpdateCollectedDataMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateCollectedData>>
>
export type UpdateCollectedDataMutationBody = UpdateCollectedDataBody
export type UpdateCollectedDataMutationError = unknown

/**
 * @summary Update collected data for a survey unit
 */
export const useUpdateCollectedData = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  const mutationOptions = getUpdateCollectedDataMutationOptions(options)
...
export const createUpdateSurveyUnit = (
  id: string,
  surveyUnitCreationInput: SurveyUnitCreationInput,
  options?: SecondParameter<typeof stromaeInstance>
) => {
  return stromaeInstance<void>(
    {
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: SurveyUnitCreationInput },
    TContext
  >
  request?: SecondParameter<typeof stromaeInstance>
}): UseMutationOptions<
...
export type CreateUpdateSurveyUnitMutationResult = NonNullable<
  Awaited<ReturnType<typeof createUpdateSurveyUnit>>
>
export type CreateUpdateSurveyUnitMutationBody = SurveyUnitCreationInput
...
export const getListSurveyUnitByCampaign = (
  ...
  return stromaeInstance<SurveyUnitByCampaignDto[]>(
