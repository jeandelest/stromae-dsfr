export const source = {
  ...
  variables: [
    ...
    { variableType: 'EXTERNAL', name: 'EXTERNAL1', value: null },
    {
      variableType: 'COLLECTED',
      values: {
        COLLECTED: null,
    ...
    },
    {
      ...
      expression: { type: 'VTL', value: 'cast(Q3, integer) + 5' },
      name: 'CALCULATED1',
      inFilter: 'false',
    },
  ],
  components: [
    ...
    },
    {
      ...
      id: 'lk6zkkfr',
      page: '2',
      label: { type: 'VTL|MD', value: '"➡ 1. " || "Question 1"' },
      mandatory: false,
      maxLength: 249,
    },
    {
    ...
    },
    {
      ...
      id: 'lk6zs7tw',
      page: '4',
      label: { type: 'VTL|MD', value: '"➡ 2. " || "Question 2"' },
      mandatory: false,
      maxLength: 249,
      declarations: [
        {
    ...
    },
    {
      ...
      conditionFilter: { type: 'VTL', value: 'true' },
      label: { type: 'VTL|MD', value: '"➡ 3. " || "Question 3"' },
      mandatory: false,
      declarations: [
        {
          declarationType: 'STATEMENT',
          ...
          label: {
            type: 'VTL|MD',
            value:
              '"Dynamic declaration using two collected: " || Q1 || " and " || Q2',
          },
          position: 'BEFORE_QUESTION_TEXT',
        },
      ],
    ...
    },
    {
      ...
      id: 'lk702f0b',
      page: '6',
      label: { type: 'VTL|MD', value: '"➡ 4. " || "Question 4"' },
      mandatory: false,
      declarations: [],
    },
    {
      ...
      id: 'lk70b3kk',
      page: '7',
      label: { type: 'VTL|MD', value: '"➡ 5. " || "Question 5"' },
      mandatory: false,
      declarations: [],
    },
    {
  ...
  pagination: 'question',
  resizing: {},
  label: { type: 'VTL|MD', value: 'Eno - Declarations and instructions' },
