...
import type {
  ...
  LunaticSlotComponents,
} from '@inseefr/lunatic'

import { useQuestionHasMultipleComponents } from './Question'

const ComponentParentContext =
  createContext<LunaticComponentProps['componentType']>(undefined)

export const ComponentWrapper: LunaticSlotComponents['ComponentWrapper'] = (
  props,
) => {
